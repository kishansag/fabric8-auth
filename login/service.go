...
type KeycloakOAuthService interface {
	...
	PerformExchange(ctx *app.GettokenAuthorizeContext, config oauth.OauthConfig, serviceConfig LoginServiceConfiguration) error
...
func (keycloak *KeycloakOAuthProvider) PerformExchange(ctx *app.GettokenAuthorizeContext, config oauth.OauthConfig, serviceConfig LoginServiceConfiguration) error {
	/* Compute all the configuration urls */
